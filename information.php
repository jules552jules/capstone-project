...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Students Records</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th scope="col">High School Year</th>
                  <th scope="col">Colloge</th>
                  <th scope="col">Colloge year</th>
                </tr>
              </thead>
              <tbody>
                <tr>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Dark Web</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
      ...
      Designed by <a href="https://ibb.co/rpNQgNy">BootstrapMade</a>
    </div>
  </footer><!-- End Footer -->
